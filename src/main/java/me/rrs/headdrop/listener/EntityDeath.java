...
public class EntityDeath implements Listener {
        ...
        if (config.getBoolean("Require-Weapon.Enable")) {
            ...
            if (!requiredEnchantment.isEmpty()) {
                ...
                if (key != null) {
                    ...
                    return enchantment == null || weapon.containsEnchantment(enchantment);
                }
            }
    ...
    protected void handleEntityDrop(EntityDeathEvent event, String entityType, Supplier<ItemStack> itemSupplier) {
        ...
        event.getEntity().getWorld().dropItem(event.getEntity().getLocation(), headItem);
